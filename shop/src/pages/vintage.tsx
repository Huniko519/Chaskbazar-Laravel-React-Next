...
export default function Home({ banners }: any) {
  return (
    <>
      <Container>
        <HeroWithCategoryFlash banners={banners?.homeFourGridBanners} />
      </Container>
      ...
      <Container>
        ...
        />
        <BannerCard
          banner={banners?.homeFourBanner?.[0]}
          href={`${ROUTES.COLLECTIONS}/${banners?.homeFourBanner?.[0].slug}`}
        ...
        />
        <BannerCard
          banner={banners?.homeFourBanner?.[1]}
          href={`${ROUTES.COLLECTIONS}/${banners?.homeFourBanner?.[1].slug}`}
          className="mb-11 md:mb-12 lg:mb-14 2xl:mb-16"
        />
        <ProductsFlashSaleBlock date={"2023-03-01T01:02:03"} />
        <BrandBlock sectionHeading="text-top-brands" />
        <ExclusiveBlock banners={banners?.exclusiveBlock} />
        <NewArrivalsProductFeed />
        <BannerCard
          banner={banners?.homeFourBanner?.[2]}
          href={`${ROUTES.COLLECTIONS}/${banners?.homeFourBanner?.[2].slug}`}
